        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                <li><a href="chartjs.do"><i class="fa fa-circle-o"></i> ChartJS</a></li>
                <li><a href="morris.do"><i class="fa fa-circle-o"></i> Morris</a></li>
                <li><a href="flot.do"><i class="fa fa-circle-o"></i> Flot</a></li>
                <li  class="active"><a href="inline.do"><i class="fa fa-circle-o"></i> Inline charts</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
