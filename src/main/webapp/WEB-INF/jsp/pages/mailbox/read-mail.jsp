    ...
    <div class="wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="compose.do">Compose</a></li>
                <li class="active"><a href="read-mail.do">Read</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="row">
            <div class="col-md-3">
              <a href="compose.do" class="btn btn-primary btn-block margin-bottom">Compose</a>
